...
class Dev(Configuration):
    ...
    ALLOWED_HOSTS = values.ListValue(["localhost", "0.0.0.0", ".codio.io", os.environ['CODIO_HOSTNAME'] + '-8000.codio.io'])
    X_FRAME_OPTIONS = "ALLOW_FROM " + os.environ.get("CODIO_HOSTNAME") + "-8000.codio.io"
